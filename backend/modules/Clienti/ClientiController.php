...
require_once __DIR__ . '/ClientiModel.php';

class ClientiController extends Controller
{
    private ClientiModel $model;

    public function __construct()
    {
        $this->model = new ClientiModel();
    }

    public function list(): void
    {
        $user = AuthMiddleware::handle();
        PermissionMiddleware::handle('clienti_manage');
        $pg = $this->pagination();
